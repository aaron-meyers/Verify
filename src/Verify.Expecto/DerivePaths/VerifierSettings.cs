...
public partial class Verifier
{
    ...
    internal static PathInfo GetPathInfo(string sourceFile, string typeName, string methodName, IReadOnlyDictionary<string, object> context) =>
        derivePath(sourceFile, TargetAssembly.ProjectDir, typeName, methodName, context);
    ...
    public static void DerivePath(DerivePath derivePath) =>
        Verifier.derivePath = derivePath;
}